...
Project done during **Full Stack Software Engineering Program** at **ALX Software Engineering Program**. It aims to learn about docstrings to create and implement tests in **Python**.
