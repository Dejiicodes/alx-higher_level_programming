# Almost a circle
Project done during **Full Stack Software Engineering Program** at **ALX Software Engineering**. It aims to learn about unit testing, serialization, deserialization, JSON, `args` and `kwargs` in **Python**.
